...
- **请求URL**
> [https://api.xbbbbbb.cn/v1/stations](https://api.xbbbbbb.cn/v1/stations)
...
- **请求URL**
> [https://api.xbbbbbb.cn/v1/station/{id}](https://api.xbbbbbb.cn/v1/stations/{id})
...
- **请求URL**
> [https://api.xbbbbbb.cn/v1/stations/{id}](https://api.xbbbbbb.cn/v1/stations/{id})
...
- **请求URL**
> [https://api.xbbbbbb.cn/v1/auth](https://api.xbbbbbb.cn/v1/auth)
